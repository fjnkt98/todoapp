...
export default function Tasks() {
  ...
  return (
    <div className="flex flex-col sm:flex-row">
      <div className="flex flex-row items-center sm:flex-col justify-between sm:justify-start width-full sm:width-1/4 sm:min-w-32 px-6 sm:px-4 sm:gap-1 gap-6 py-2">
        <Link
      ...
      <div className="px-1 py-1 w-full mx-auto">
        <table className="w-full">
          ...
          <tbody>
            {data.map((d) => (
              <tr key={d.id}>
                <td className="text-sm px-2 py-2 text-center border-b border-gray-600">
                  {d.id}
                </td>
                <td className="text-sm px-2 py-2 text-left border-b border-gray-600 truncate">
                  {d.title}
                </td>
                <td className="text-sm px-2 py-2 text-center border-b border-gray-600 max-w-8">
                  {formatStatus(d.status)}
                </td>
                <td className="text-sm px-2 py-2 text-center border-b border-gray-600 max-w-12">
